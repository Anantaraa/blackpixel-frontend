                    ...
                    <div className="lg:col-span-5">
                        ...
                        >
                            <h2 className="text-6xl md:text-8xl font-medium font-display uppercase leading-[0.85] tracking-tighter mb-8 text-text">
                                Our <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-text to-text/50">Expertise</span>
                            </h2>
                            <p className="text-text-muted text-lg max-w-sm border-l border-neutral-border pl-6 mt-12">
                            ...
                            {SERVICES.map((service, index) => (
                                ...
                                >
                                    <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-6 mb-4 px-4">
                                        ...
                                        <ArrowUpRight className="w-6 h-6 text-text-muted/50 group-hover:text-primary group-hover:rotate-45 transition-all duration-500" />
                                    </div>
